...
我們將 **抓取引用作為函數參數** 稱為 **借用**（*borrowing*）。正如現實生活中，如果一個人擁有某樣東西，你可以從他那裡借來。當你使用完畢，必須還回去。

如果我們嘗試修改借用的變數呢？嘗試示例 4-9 中的代碼。劇透：這行不通！
...
<span class="caption">示例 4-9：嘗試修改借用的值</span>
...
可以通過一個小調整來修復在示例 4-9 代碼中的錯誤，在示例 4-9 的代碼中：
